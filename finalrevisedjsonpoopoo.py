...
openai.api_key = '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'
...
def scrape_and_generate_summary(url):
    ...
    if response.status_code == 200:
        ...
        if is_article(soup):
            ...
            prompt2 = f"""Title: {article_title}, First 500 characters: {summary}, In 500 characters or less, please also generate a revised summary that summarizes the key points of the article. Also can you just make it so that it's always just the summary and not preface it with "Summary:"."""
